...
if ($pfstatus =='ไถ่ถอนแล้ว'){
  ...
  <h4 style='color: gold;'>ไถ่ถอน</h4>
  </div>"
  ;
}else if ($date_current <= 0){
$pfstatus="
<div class='col-3 ms-auto'><h4 style='color: red;'>หมดอายุสัญญา</h4></div>";
}else if ($date_current > 0){
  $pfstatus="<div class='col-2 ms-auto'><h4 style='color: green;'>ขายฝาก</h4></div>";
  }
?>
