  ...
  <div class="container-lg" style="max-width: 1100px; margin-top: 130px; margin-bottom: 80px">
    ...
    <div class="w3-row w3-container">
      ...
      <div class="row align-items borderrow">
        <div class="col">
          <a href="AnnounceContent.php?id=7&action=content"><img src="img/ข่าว50ปี.png" style="width: 100%" /></a>
        </div>
        <div class="col">
          <a href="AnnounceContent.php?id=8&action=content"><img src="img/ข่าวเหลือง.jpg" style="width: 100%" /></a>
        </div>
      </div>
    </div>
    ...
    <div class="w3-row w3-container">
      ...
      <div class="row align-items borderrow">
        <div class="col">
          <a href="PromotionContent.php?id=11&action=content"><img src="img/pro7.png" style="width: 100%" /></a>
        </div>
        <div class="col">
          <a href="PromotionContent.php?id=6&action=content"><img src="img/pro5.png" style="width: 100%" /></a>
        </div>
      </div>
    </div>
  </div>
