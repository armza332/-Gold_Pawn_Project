                    ...
                    ทำรายการ
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-body">
                                            ต้องการทำรายการชำระเงินต้นรายการนี้ใช่หรือไม่
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">ยกเลิก</button>
                                           
                                            <a class="btn btn-primary" href="Addprincipal_pay.php?continueID=<?php echo $rows['id'];?> " style="color: white;">ยืนยันการทำรายการ</a>
                                        </div>
                                        </div>
                                    </div>
                                    </div>
