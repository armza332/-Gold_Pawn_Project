...
<nav class="navbar navbar-expand-lg fixed-top navbar-dark navcolor">
				...
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
							...
							<li>
								<a class="dropdown-item" href="#">เพิ่มเงินต้น</a>
							</li>
							<li>
								<a class="dropdown-item" href="#">ตัดต้น</a>
							</li>
							<li>
								<a class="dropdown-item" href="#">ต่อดอกเบี้ย</a>
							</li>
							<li>
    ...
    <div class="container-fluid bordersr" style="margin-bottom: 20px;">
		...
		<h1 class="title" style="margin-bottom:10px;">Menu</h1>
			...
			<div class="row">
				...
				<div class="d-grid gap-2 mx-auto col">
					<a href="PawnForm.html" class="mybtn">รายการขายฝาก</a>
				</div>

				<div class="d-grid gap-2 mx-auto col">
					<a href="Retunform.html" class="mybtn">รายการไถ่ถอน</a>
				</div>
			</div>

			<div class="row">
				<div class="d-grid gap-2 mx-auto col">
					<a href="#" class="mybtn">รายการต่อดอกเบี้ย</a>
				</div>
				<div class="d-grid gap-2 mx-auto col">
					<a href="#" class="mybtn">รายการเพิ่มเงินต้น</a>
				</div>
			</div>

			<div class="row">
				<div class="d-grid gap-2 mx-auto col">
					<a href="#" class="mybtn">รายการขำระเงินต้น</a>
				</div>
				<div class="d-grid gap-2 mx-auto col">
      ...
      <div class="row">
				<div class="d-grid gap-2 mx-auto col">
					<a href="#" class="mybtn">จัดการประชาสัมพันธ์</a>
				</div>
				<div class="d-grid gap-2 mx-auto col">
					<a href="CusForm.html" class="mybtn">จัดการโปรโมชั่น</a>
				</div>
			</div>
