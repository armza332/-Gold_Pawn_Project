...
<body>
	<div class="container">
		...
		<?php
		$string="0123456789";
		$gpassword= substr(str_shuffle($string),0,8);
		?>
	</div>
	<!-- Navbar -->
					...
					<div class="container">
						...
						<form action="CusForm_db.php" method="post">
								...
								<div class="col-2">
									<div>
										<label class="form-row-inner">
											<select name="title"  style="text-align: center; font-size :18px;" class="pb-1 pt-1 mt-2">
							...
							<div class="row">
								...
								<div class="col">
									<div class="input-group">
										<input type="email" class="input--style-2 " name="email" aria-describedby="email" placeholder="E-mail">
									</div>
								</div>
							</div>
							<div class="row">
							...
							<div class="row">
								<div class="col">
										...
										<div class="form-holder">
											<label for="annotation" class="special-label" style="font-size:16px;">รหัสผ่านของลูกค้า : <?php echo $gpassword; ?></label>
							...
							<div class="row">
								<div class="col">
									<div class="input-group" style="display:none">
										<input type="password" class="input--style-2 " name="password" placeholder="<?php echo $gpassword; ?>" value="<?php echo $gpassword; ?>" disabled="disabled" >
								...
								<div class="input-group" style="display:none">
										...
										<input type="text" class="input--style-2 " name="gp" value="<?php echo $gpassword; ?>"  >
									</div>
								</div>
							</div>
								...
								<div class="col d-flex flex-row-reverse">
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">สมัครสมาชิกลูกค้า</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body">
                                            ต้องการสมัครสมาชิกลูกค้ารายการนี้ใช่หรือไม่
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">ยกเลิก</button>
                                            <button type="submit" name="signup" class="btn btn-primary" >ยืนยันการบันทึกข้อมูล</button>
...
{
var agree=confirm("ต้องการยืนยันการสมัครนี้ใช่หรือไม่?");
if (agree)
 return true ;
else
 return false ;
