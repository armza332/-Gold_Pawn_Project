...
<head>
    <meta charset="utf-8" />
    <title>แบบฟอร์มรายการข่าวประชาสัมพันธ์</title>
                    ...
                    <div class="col-md-3">
                        <div class="list-group list-group-item-action">
                            ...
                            <a href="AddAnnounce.php" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-list-alt"
                                    aria-hidden="true"></span> รายการข่าวประชาสัมพันธ์ <span class="badge"></span>
                            </a>
                                ...
                                <form action="AnnounceSave.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">เพิ่มข่าวประชาสัมพันธ์</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body">
                                            ต้องการเพิ่มข่าวประชาสัมพันธ์ใช่หรือไม่
                                        </div>
...
{
var agree=confirm("ต้องการเพิ่มข่าวประชาสัมพันธ์นี้ใช่หรือไม่?");
if (agree)
 return true ;
else
 return false ;
