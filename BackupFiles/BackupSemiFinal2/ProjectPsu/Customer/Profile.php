...
<body>
  <div class="container">
    ...
    if (isset($_SESSION['user_login'])) {
      $num_per_page = 6; //จำนวนหน้าที่แสดง
      ...
      $pf = $conn->query("SELECT * FROM pawnform WHERE idcard = $iduser AND pf_status = 'จำนำ' AND pf_expdate > now() limit $start_from,$num_per_page");
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
              ...
              <li>
                <a class="dropdown-item" href="FAQPawn.php">เกี่ยวกับการขายฝาก</a>
              </li>
              <li>
                <a class="dropdown-item" href="FAQinterest.php">ดอกเบี้ย</a>
              </li>
              <li>
                <a class="dropdown-item" href="FAQticket.php">ตั๋วขายฝาก</a>
              </li>
            </ul>
          </li>
          <li class="nav-item">
          ...
          <div class="col-md-8">
            <div class="card mb-3">
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <a class="btn btn-danger " href="ProfileEdit.php?update_id=<?php echo $row['id']; ?> " style="color: white;">แก้ไขข้อมูล</a>
                    <a class="btn btn-warning " href="PasswordEdit.php?update_id=<?php echo $row['id']; ?> ">เปลี่ยนรหัสผ่าน</a>
            ...
            <div class="row gutters-sm">
              <div class="col mb-3">
                <div class="card h-100">
                  <div class="card-body">
                    <h3 class="d-flex align-items-center mb-3">รายการขายฝากของ <?php echo $row['firstname']; ?>  </h3>
                    <a href="historypf.php" style="color:white" class="ms-1 btn btn-secondary mb-3"> ประวัติทั้งหมด</a>
                        ...
                        <div style="border: 3px solid; padding: 10px;margin-bottom:20px; border-radius: 0.5rem;" class="ps-4 pe-4">
                          <div class="row mb-2 mt-2">
                            ...
                            <div class="col-2 ms-auto">
                              <h3 style="color: green;">ขายฝาก</h3>
                            </div>
                          ...
                          <div class="row mb-3">
                            <div class="col">
                              <label>วันที่เริ่มขายฝาก : <?php echo $rows['pf_create_at']; ?></label>
                            </div>
                            <div class="col">
                    ...
                    <div class="col-3 ms-auto " >
                      ...
                      for ($i = 1; $i <=3;$i++) {
                        echo "<a href='profile.php?page=" . $i . "' style='font-size: 150%;'>"."[ " . $i . " ] "."</a>";
