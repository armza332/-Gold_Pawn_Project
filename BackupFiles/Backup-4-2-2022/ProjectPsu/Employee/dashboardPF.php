...
<body>
    <div class="container">
        <?php 
            ...
            if (isset($_SESSION['superadmin_login'])) {
              $pf = $conn->query("SELECT * FROM pawnform WHERE  pf_status='จำนำ'");
              $pf->execute();
...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
  <img src="ห้างทองแสงสุวรรณ3.png" class="navbar-brand logo" style="width: 13% ; padding-left: 10px;padding-right: 15px"
