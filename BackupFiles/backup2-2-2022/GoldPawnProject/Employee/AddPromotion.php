        ...
        <section id="main">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9 box">
                        ...
                        <div class="panel panel-default">
                            <div class="heading">
                                <h3 class="">เพิ่มข่าวโปรโมชั่น</h3>
                            </div>
            ...
            <?php } ?>
                                <div class="form-group">
                                        <label>หัวข้อ</label>
                                        <input type="text" name="title" class="form-control" placeholder="หัวข้อข่าวโปรโมชั่น"
                                            >
                                    </div><br>
                                    <div class="form-group">
                                        <label>เนื้อหา</label>
                                    ...
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" name="status"> เผยแพร่
                                        </label>
                                    </div>
                                    <br>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name ="note" class="form-control" placeholder="เพิ่มหมายเหตุ">
