...
<div>
    ...
    <div class="container-lg" style="max-width: 1100px; margin-top: 130px; margin-bottom: 80px">
      ...
      <!-- Banner -->
        <div>
            <img src="https://chl-cloudinary.corebine.com/chl-production/image/upload/c_fit,dpr_3.0,f_webp,g_center,h_430,q_auto,w_768/v1/chl-prod/CHL_Announcement" style="width: 100%; margin-bottom: 80px" />
        </div>
    <div class="borderrow">
        <div class="row">
            <div class="col mb-4">
                <div class="card" style="width: auto;">
                    <img src="https://traderider.com/forex/wp-content/uploads/2020/04/gold-3.jpg" class="img-fluid" alt="...">
                    <div class="card-body">
                      <h5 class="card-title">หัวข้อข่าาประชาสัมพันธ์ 1</h5>
                      <p class="card-text" style="height: 30px ">เนื้อหาข่าวประชาสัมพันธ์.</p>
                      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        <button class="btn btn-primary" type="button">อ่านเพิ่มเติม</button>
                    </div>
                    </div>
                </div>
            </div>
              <div class="col mb-4">
                <div class="card" style="width: auto; height: fit-content;">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTiX8ThwTYD-qq6fFAQVmavlOQ6bnlFG9kFPA&usqp=CAU" class="img-fluid" alt="...">
                    <div class="card-body">
                      <h5 class="card-title">หัวข้อข่าาประชาสัมพันธ์ 2</h5>
                      <p class="card-text" style="height: 30px" maxlength="5">เนื้อหาข่าวประชาสัมพันธ์</p>
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <button class="btn btn-primary" type="button">อ่านเพิ่มเติม</button>
                        </div>
                    </div>
              ...
              <div class="col mb-4">
                <div class="card" style="width: auto;">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSgb6dGKjTP94uBn7tbtpKmGid_4aeKeN4Lsg&usqp=CAU" class="img-fluid" alt="...">
                    <div class="card-body" style="height: 50%">
                      <h5 class="card-title">หัวข้อข่าาประชาสัมพันธ์ 3</h5>
                      <p class="card-text " style="height: 30px ">เนื้อหาข่าวประชาสัมพันธ์</p>
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <button class="btn btn-primary" type="button">อ่านเพิ่มเติม</button>
                        </div>
              ...
              <div class="col mb-4">
                <div class="card" style="width: auto;">
                    <img src="https://www.tidlor.com/tidlor/media/tidlor-image/article/5-ways-fake-gold-different-real-gold/og-5-ways-fake-gold-different-real-gold.jpg" class="img-fluid" alt="...">
                    <div class="card-body" style="height: 50%">
                      <h5 class="card-title">หัวข้อข่าาประชาสัมพันธ์ 4</h5>
                      <p class="card-text " style="height: 30px ">Some quick example text to build on the หัวข้อข่าาประชาสัมพันธ์ and make up the bulk of the card's content
                        sdfsdfsdfsdfsdfsdfsdfsedfsdfsdfsdfsdfsdfsdfsdfsdf.</p>
                      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <button class="btn btn-primary" type="button">อ่านเพิ่มเติม</button>
                      </div>  
                    </div>
