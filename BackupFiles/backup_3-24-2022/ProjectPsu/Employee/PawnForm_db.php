        ...
        if (empty($pf_type)) {
            ...
            try {
               ...
               if (!isset($_SESSION['error'])) {
                   $stmt = $conn->prepare("INSERT INTO pawnform(pf_type, pf_weight, pf_price, idcard, pf_expdate, pf_des, pf_status) VALUES (:pf_type, :pf_weight, :pf_price, :idcard, :pf_expdate, :pf_des, :pf_status)");
