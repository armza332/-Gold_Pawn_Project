...
<body>
  <div class="container">
    ...
    if (isset($_SESSION['user_login'])) {
      ...
      $pf = $conn->query("SELECT * FROM pawnform WHERE idcard = $iduser AND pf_status = 'จำนำ'");
...
<form action="returnform_db.php" method="post">
  <div style="border: 3px solid; padding: 10px;margin-bottom:20px; border-radius: 0.5rem;">
    <div class="row mb-1">
      <div class="col-4">
        <h5>รหัสรายการขายฝาก : <?php echo $rows['id']; ?></h5>
      </div>

      <div class="col-2">
        <h5 style="color: green;"><?php echo $rows['pf_status']; ?></h5>
      </div>
      <div class="col-1">
...
<?php } ?>
<div class="col-3 ms-auto" style="padding-right: -100px;">
<a class="btn btn-primary"  href="historypf.php" style="color:white">ประวัติรายการขายฝาก</a>
