          ...
          <div class="row gutters-sm">
              <div class="col mb-3">
                <div class="card h-100">
                  <div class="card-body">
                  <h3 class="d-flex align-items-center mb-3">ประวัติรายการขายฝากของ <?php echo $row['firstname']; ?></h3>
...
<?php } ?>
<div class="col-2 ms-auto" style="padding-right: -100px;">
<a class="btn btn-danger"  href="Profile.php" style="color:white">ย้อนกลับ</a>
