...
<body>
  ...
  <div class="container-lg" style="max-width: 1100px; margin-top: 130px; margin-bottom: 80px">
    ...
    <div class="row align-items borderrow">
      <div class="col">
        <img src="img/รูปหน้าร้าน.png" style="width: 85%; margin-left: 50px" />
      </div>
      <div class="col textcontact" style="margin-right: 50px;text-align:left;">
        <h1>ห้างทองแสงสุวรรณ</h1>
        <h6>
          ห้างทองแสงสุวรรณ ให้บริการจำนำทรัพย์หลากหลายประเภททั้งทองคำแท่ง ทองคำรูปพรรณต่างๆ 
          เราพร้อมให้บริการสินเชื่อแบบมีทรัพย์ค้ำประกันแก่ประชาชนในพื้นที่สุไหงโก-ลก 
          ด้วยบริการอย่างมืออาชีพจากทีมงานผู้เชี่ยวชาญในการประเมินทรัพย์ 
          ให้ราคาที่เป็นธรรมในอัตราสูงสุดของมูลค่าทรัพย์ ซึ่งมุ่งเน้นการให้เกียรติลูกค้าพร้อมสร้างความประทับใจในทุกครั้งที่เข้าใช้บริการ
          ภายใต้หลักการ “วันมา วันกลับ ทรัพย์เหมือนเดิม”
        </h6>
      </div>
    </div>
  </div>
