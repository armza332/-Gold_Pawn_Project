        ...
        <?php
            ...
            echo "
              ...
              <div class='border row mb-4 '>
                  ...
                  <div class='col' '>
                      <img src='{$announce['picture']}' class='pic rounded-2'>
                  </div>
                  <div class='col mt-2 text-break'>
                      <h2 class='mb-4'>{$announce["header"]}</h2>
                      <div class='col'>
                          <a href='NLAnnounceContent.php?id={$announce['id']}&action=content' class='btn btn-danger mt-5 float-end' style='color:white'>อ่านเพิ่มเติม</a>
                      </div>
                  </div>
              </div> 
