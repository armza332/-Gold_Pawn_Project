                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="list-group">
                            <a href="Announce.php" class="list-group-item active main-color-bg">
                    ...
                    <div class="col-md-9 box">
                        ...
                        <div class="panel panel-default">
                            <div class="heading">
                                <h3 class="">แก้ไขข่าวโปรโมชั่น</h3>
                            </div>
                            <div class="panel-body">
                                <form>
                                    <div class="form-group">
                                        <label>หัวข้อ</label>
                                        <input type="text" class="form-control" placeholder="หัวข้อข่าวโปรโมชั่น"
                                            value="ข่าวโปรโมชั่น 1">
                                    </div><br>
                                    <div class="form-group">
                                        <label>เนื้อหา</label>
                              ...
                              Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
                                    ...
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" checked> เผยแพร่
                                        </label>
                                    </div>
                                    <br>
                                    <div>
                                        <label>วันที่เผยแพร่</label>
                                        <input type="date" class="form-control" value="28 ธันวาคม 2021">
                                    </div>
                                    <br>
                                    <div class="form-group">
                                        <label>Tags</label>
                                        <input type="text" class="form-control" placeholder="เพิ่ม Tags "
                                            value="tag1, tag2">
                                    </div>
                                    <br>
                                    <div class="form-group">
                                        <label>หมายเหตุ</label>
                                        <input type="text" class="form-control" placeholder="เพิ่มหมายเหตุ"
                                            value="  Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et ">
                                    </div>
                                    <br>
                                    <!-- Button trigger modal -->
                                    <button type="button" class="btn-lg btn-primary mb-2" data-bs-toggle="modal"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="staticBackdropLabel">บันทึกการแก้ไข</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                        aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body">
                                                    ต้องการบันทึกการแก้ไขใช่หรือไม่
                                                </div>
