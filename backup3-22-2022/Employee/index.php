				...
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
							<li>
								<a class="dropdown-item" href="login.php">ขายฝาก</a>
							</li>
							<li>
								<a class="dropdown-item" href="login.php">ไถ่ถอน</a>
							</li>
							<li>
								<a class="dropdown-item" href="login.php">เพิ่มเงินต้น</a>
							</li>
							<li>
								<a class="dropdown-item" href="login.php">ตัดต้น</a>
							</li>
							<li>
								<a class="dropdown-item" href="login.php">ต่อดอกเบี้ย</a>
							</li>
							<li>
								<a class="dropdown-item" href="login.php">สมัครสมาชิกลูกค้า</a>
							</li>
						</ul>
					</li>
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
							<li><a class="dropdown-item" href="login.php">ข่าวประชาสัมพันธ์</a></li>
							<li>
								<a class="dropdown-item" href="login.php">ข่าวโปรโมชั่น</a>
							</li>
						</ul>
					</li>
