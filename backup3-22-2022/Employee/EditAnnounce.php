                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="list-group">
                            <a href="Announce.html" class="list-group-item active main-color-bg">
                    ...
                    <div class="col-md-9 box">
                        ...
                        <div class="panel panel-default">
                            <div class="heading">
                                <h3 class="">แก้ไขข่าวประชาสัมพันธ์</h3>
                            </div>
                            <div class="panel-body">
                                <form>
                                    <div class="form-group">
                                        <label>หัวข้อ</label>
                                        <input type="text" class="form-control" placeholder="หัวข้อข่าวประชาสัมพันธ์"
                                            value="ข่าวประชาสัมพันธ์ 1">
                                    </div><br>
                                    <div class="form-group">
                                        <label>เนื้อหา</label>
