    ...
    <div class="container-fluid bordersr" style="margin-bottom: 20px;">
      <form class="d-flex">
		...
		<h1 class="title" style="margin-bottom:10px;">Menu</h1>
			...
			<div class="row">
				<div class="d-grid gap-2 mx-auto col">
					<a href="continueform.html" class="mybtn">รายการต่อดอกเบี้ย</a>
				</div>
				<div class="d-grid gap-2 mx-auto col">
					<a href="Increase_Principal.html" class="mybtn">รายการเพิ่มเงินต้น</a>
				</div>
			</div>

			<div class="row">
				<div class="d-grid gap-2 mx-auto col">
					<a href="principal_pay.html" class="mybtn">รายการขำระเงินต้น</a>
				</div>
				<div class="d-grid gap-2 mx-auto col">
      ...
      <div class="row">
				<div class="d-grid gap-2 mx-auto col">
					<a href="Announce.php" class="mybtn">จัดการประชาสัมพันธ์</a>
				</div>
				<div class="d-grid gap-2 mx-auto col">
					<a href="Promotion.php" class="mybtn">จัดการโปรโมชั่น</a>
				</div>
			</div>
