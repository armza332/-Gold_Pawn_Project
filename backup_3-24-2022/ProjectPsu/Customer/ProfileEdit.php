...
if($_FILES['upload']['tmp_name']) {
	...
	$avatar = "/ProjectPsu/GoldPawnProject/customer/img/" . md5(uniqid()) . ".{$ext}"; //รวมเป็นชื้่อใหม่
...
if (isset($_REQUEST['btn_update'])) {
  ...
  $picss = end(explode(".",$_REQUEST['picture']));
  $picture_up = "/ProjectPsu/GoldPawnProject/customer/img/$picss";
...
<body>
  ...
  <nav class="navbar navbar-expand-lg fixed-top navbar-dark navcolor">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">แก้โปรไฟล์ส่วนตัว</li>
    </ol>
  </nav>
<?php
            ...
            <form method="post" enctype="multipart/form-data">
              ...
              <div class="row mb-3">
							...
							<div class="row">
								...
								<div class="col-sm-9 text-secondary">
									<input type="submit" name="btn_update" class="btn btn-succcess px-4" value="บันทึกการแก้ไข">
