...
<body>
  <div class="container">
    ...
    if (isset($_SESSION['user_login'])) {
      ...
      $pf = $conn->query("SELECT * FROM pawnform WHERE idcard = $iduser");
...
<form action="returnform_db.php" method="post">
  <div style="border: 3px solid; padding: 10px;margin-bottom:20px; border-radius: 0.5rem;">
    ...
    <div class="row mb-2">
      ...
      <div class="col">
        <label>ดอกเบี้ย : <?php echo $resultnet; ?>  บาท</label>
      </div>
    </div>
    <div class="row mb-2">
      <div class="col-5">
    ...
    <div class="col d-flex flex-row-reverse">
        <label style="padding-top: 15px;">ราคาค้างชำระสุทธิ : <?php echo $results; ?></label>
      </div>
