  ...
  <div class="page-wrapper  p-t-50 p-b-50 font-robo">
    <div class="wrapper wrapper--w960">
      <div class="card card-2">
        ...
        <div class="card-body">
          <div class="container">
            <h3 class=" title">รายการการไถ่ถอน</h3>
              ...
              <form action="returnform_db.php" method="post">
                <div style="border: 3px solid; padding: 10px;margin-bottom:20px; border-radius: 0.5rem;">
                  ...
                  <div class="col d-flex flex-row-reverse">
                      <label style="padding-top: 15px;">ราคาชำระสุทธิ : <?php echo $results; ?></label>
                    </div>
                    <div class="col-2 d-flex flex-row-reverse">
                      <button type="submit" class="btn btn-danger" name="unactive" onClick='return confirmSubmit()'>ไถ่ถอน</button>
                    </div>
