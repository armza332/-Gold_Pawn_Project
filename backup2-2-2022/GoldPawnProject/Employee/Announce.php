                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="list-group list-group-item-action">
                            ...
                            <a href="Announce.html" class="list-group-item"><span class="glyphicon glyphicon-list-alt"
                        ...
                        <div class="panel-default">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input class="form-control" type="text"
                                            placeholder="ค้นหารายการข่าวประชาสัมพันธ์">
                                    </div>
                                </div>
                                <br>
                                <table class="table table-striped table-hover">
                                    ...
                                    <tr>
                                        <td>ข่าวประชาสัมพันธ์ 5</td>
                                        <td><span class="glyphicon glyphicon-ok" aria-hidden="true">เผยแพร่แล้ว</span>
                                        </td>
                                        <td>13 มกราคม 2022</td>
                                        <td><a class="btn btn-default" href="EditAnnounce.php">Edit</a> <a
                                                class="btn btn-danger" href="#">Delete</a></td>
                                    </tr>
                                    <tr>
                                        <td>ข่าวประชาสัมพันธ์ 6</td>
                                        <td><span class="glyphicon glyphicon-ok" aria-hidden="true">เผยแพร่แล้ว</span>
                                        </td>
                                        <td>13 มกราคม 2022</td>
                                        <td><a class="btn btn-default" href="EditAnnounce.php">Edit</a> <a
                                ...
                                <div class="text-center mb-2">
                                    <a type="button" class="btn btn-primary"
                                        href="AddAnnounce.php">เพิ่มข่าวประชาสัมพันธ์</a>
                                </div>
